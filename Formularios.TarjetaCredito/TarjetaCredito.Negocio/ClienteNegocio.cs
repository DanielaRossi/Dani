...
namespace TarjetaCredito.Negocio
{
    public class ClienteNegocio
    {
        ...
        public ResultadoTransaccion Agregar(string nombre, string apellido, DateTime fechaNac, long dni, string tel, string dir, bool act, string email = "alumnocai1@yopmail.com")
        {
            ...
            ResultadoTransaccion result = _clinteMapper.Insertar(cliente);
        ...
        public ResultadoTransaccion Modificar(int codigo, string nombre, string apellido, DateTime fechaNac, long dni, string telefono, string direccion, bool activo, string email)
        {
            Cliente cliente = new Cliente();
            cliente.id = codigo;
            cliente.Nombre = nombre;
            ...
            ResultadoTransaccion result = _clinteMapper.Actualizar(cliente);
