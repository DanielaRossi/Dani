...
using POO.PRESENTISMO.BIBLIOTECA;
using POO.PRESENTISMO.CONSOLAUTILS;


namespace POO.PRESENTISMO.CONSOLA
{
    public class Program
    {
            ...
            //int registro = CONSOLAUTILS.CONSOLAUTILS.PedirInt("REGISTRO");
            //int registro = ConsolaUt.PedirInt("Registro");
        }
